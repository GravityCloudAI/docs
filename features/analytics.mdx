...
title: 'Analytics'
description: 'MatterAI provides comprehensive analytics that help engineering teams gain insights into their development processes, code quality, and team performance. These analytics are designed to improve productivity, code quality, and overall engineering efficiency.'
og:title: "Code Review Analytics | MatterAI Documentation"
og:description: "MatterAI provides comprehensive analytics that help engineering teams gain insights into their development processes, code quality, and team performance. These analytics are designed to improve productivity, code quality, and overall engineering efficiency."
---

<Note>
Analytics are available on all plans.
</Note>

## PR Analytics

MatterAI tracks the lifecycle of pull requests to help teams optimize their development workflow and provides a high-level summary of key PR metrics across your repositories:

<Frame>
<img
  className="block"
  src="/images/features/analytics-pr.png"
  alt="MatterAI PR Analytics"
/>
</Frame>
...
MatterAI provides detailed analytics on automated code reviews, helping teams understand the types of issues being detected and resolved:

<Frame>
<img
  className="block"
  src="/images/features/analytics-code-reviews.png"
  alt="MatterAI Code Review Analytics"
/>
</Frame>

### Key Metrics

- **Total AI Reviews**: The number of automated code reviews performed by MatterAI
...
MatterAI provides detailed metrics on individual developer performance to help identify strengths and areas for improvement:

<Frame>
<img
  className="block"
  src="/images/features/analytics-user-performance.png"
  alt="MatterAI User Performance"
/>
</Frame>
...
All analytics in MatterAI can be filtered by:
...
MatterAI's analytics provide several key benefits for engineering teams:
...
To access MatterAI analytics:

1. Navigate to the **Home** section in your MatterAI dashboard
