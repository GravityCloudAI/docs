...
title: 'Agentic Chat'
description: 'Agentic Chat is a powerful feature that allows engineers to chat with their pull requests using MatterAI.'
og:title: "Code Review Agentic Chat | MatterAI Documentation"
og:description: "Agentic Chat is a powerful feature that allows engineers to chat with their pull requests using MatterAI."
---
...
MatterAI: The changes in postDeployStep remove the branch-specific deployment filtering logic:
...
MatterAI: Technical implementation of wildcard pattern matching in the old code:
...
MatterAI: Technical rationale for removing branch filtering:
...
MatterAI: Technical risks and considerations:
...
MatterAI: [Using web search tool...]
