...
## MATTER.md
Similar to Cursor Rules, you can define rules in a `MATTER.md` file in the root of your repository. This file will be automatically detected and applied by Matter AI during code reviews.

`MATTER.md` file can contain two sections:

- `# CODE_GEN_RULES` section: Define rules for code generation
...
# CODE_REVIEW_RULES
1. Code Format
   - Always add documentation for new and updated code
   - Always define variables in snake_case
   - All APIs should support correct error messages in response
```

## Cursor Rules and Claude.md
If you have exisitng Cursor Rules or Claude.md files in your repositories, Matter AI can automatically detect and apply these rules during code reviews. This ensures that your established coding standards and practices are consistently enforced without any additional configuration. Check [Configurations](/features/configurations) to enable this feature.
