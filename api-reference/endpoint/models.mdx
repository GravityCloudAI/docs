---
title: "List Models"
api: "GET https://api.matterai.so/v1/models"
description: "List all available models from the MatterAI API"
og:title: "Axon Models API Reference | MatterAI Documentation"
og:description: "List all available models from the MatterAI API"
og:url: "https://docs.matterai.so/api-reference/endpoint/models"
---
...
const response = await fetch('https://api.matterai.so/v1/models', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer MATTERAI_API_KEY'
  }
