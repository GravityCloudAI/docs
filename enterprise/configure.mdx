...
Mark repositories that Matter AI should not review automatically. Manual reviews can be triggered for these repositories using `/matter` [commands](/features/command-list).
