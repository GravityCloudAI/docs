...
MatterAI implements a comprehensive Role Based Access Control (RBAC) system to manage user permissions within the platform. This system defines different user roles, each with specific permissions that determine what actions users can perform.

## Available Roles

MatterAI offers the following roles with increasing levels of access:
...
MatterAI implements two primary permission types:
