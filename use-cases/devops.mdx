...
<img
  ...
  alt="MatterAI Self Serve DevOps"
/>

## Stacks - Automation

<Note>Save 30% DevOps time and effort using MatterAI</Note>

MatterAI Stacks are your go-to customisable modules to create and launch resources on cloud platforms. This can include:
- VPC
- AWS ECS Services
- Kubernetes Clusters
- Databases
