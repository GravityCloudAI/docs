---
title: Gravity Cloud for DevOps
icon: "cloud"
...
<img
  ...
  alt="Gravity Cloud Self Serve DevOps"
/>

## Stacks - Automation

<Note>Save 30% DevOps time and effort using Gravity Cloud</Note>

Gravity Cloud Stacks are your go-to customisable modules to create and launch resources on cloud platforms. This can include:
- VPC
- AWS ECS Services
- Kubernetes Clusters
- Databases
