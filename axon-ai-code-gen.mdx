...
{/* | Input Price (`>256K`) | `$4.00/1M tokens` | */}
{/* | Output Price (`>256K`) | `$10.00/1M tokens` | */}
...
| Context Window Size | `256K tokens` |
| Max Output Tokens | `32,768` |
| Input Price (`<256K`) | `$0.80/1M tokens` |
| Output Price (`<256K`) | `$2.00/1M tokens` |
{/* | Input Price (`>256K`) | `$1.6/1M tokens` | */}
{/* | Output Price (`>256K`) | `$4/1M tokens` | */}
| Input Modalities | `Text`, `Image` |
| Output Modalities | `Text` |
| Capabilities | `Function Calling`, `Tool Calling`, `Reasoning` |
