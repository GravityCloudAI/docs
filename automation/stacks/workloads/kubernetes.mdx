...
Matter AI provides a clean, actionable and detailed overview of your current and new services.
...
2. Matter AI will automatically detect your EKS cluster and start scraping it. This scraping is done by external agent so your k8s cluster does not incurr any additional resources.
3. To enable workloads data, you need to give permissions to Matter AI to access your cluster. You can do this by running the following command:
```
...
You can also download the Matter AI app to run local clusters and cloud clusters with more real-time data. You can download the Linux, Mac, or Windows the app from https://gravitycloud.ai/download.

> Quick read: https://gravitycloud.ai/blog/open-lens-vs-gravity-cloud