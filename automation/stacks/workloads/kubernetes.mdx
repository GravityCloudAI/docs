...
You can also download the Gravity Cloud app to run local clusters and cloud clusters with more real-time data. You can download the Linux, Mac, or Windows the app from https://gravitycloud.ai/download.
