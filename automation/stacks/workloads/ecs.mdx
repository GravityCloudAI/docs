...
![ECS Services Overview](https://res.cloudinary.com/dor5uewzz/image/upload/v1721402369/ECS/ecs-2_n4is9q.png)
...
![Launch new ECS Service Part 1](https://res.cloudinary.com/dor5uewzz/image/upload/v1721402370/ECS/ecs-0_c25djd.png)
...
![Launch new ECS Service Part 2](https://res.cloudinary.com/dor5uewzz/image/upload/v1721402377/ECS/ecs-1_wufbys.png)

<Note>Once launched, Gravity Cloud will automatically take care of Task Definations, LoadBalancers, Target groups, Security Groups without the team needing to manage them.</Note>
...
![ECS Services Configuration](https://res.cloudinary.com/dor5uewzz/image/upload/v1721402367/ECS/ecs-3_ibtyks.png)

### Service Rollbacks
- Check deployments status, history and perform Rollbacks

![ECS Services Rollbacks](https://res.cloudinary.com/dor5uewzz/image/upload/v1721402370/ECS/ecs-4_ikvjpd.png)

### Service Monitoring
- Validate Events and Tasks for any errors

![ECS Services Monitoring](https://res.cloudinary.com/dor5uewzz/image/upload/v1721402368/ECS/ecs-5_flom2x.png)

### Services Domain Management
- Attach Route53 domains or External domains in 1 click 

![ECS Services  Domain Management](https://res.cloudinary.com/dor5uewzz/image/upload/v1721402368/ECS/ecs-6_mgy29u.png)
