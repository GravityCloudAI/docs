...
1. Visit https://console.gravitycloud.ai/stacks and then click on Setup for Database stack. Or directly visit: https://console.gravitycloud.ai/stacks?stackId=aurora-postgres-cluster-create
