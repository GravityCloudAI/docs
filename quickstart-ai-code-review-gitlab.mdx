...
<Frame>
  <img
    src="/images/connectors/gitlab/gitlab-user.png"
...
<Frame>
  <img
    src="/images/connectors/gitlab/gitlab-pat.png"
    alt="Generating Personal Access Token"
  />
</Frame>

<Frame>
  <img
    src="/images/connectors/gitlab/gitlab-pat-scopes.png"
    alt="Generating Personal Access Token"
  />
</Frame>

<Note>Remember that personal access tokens have expiration dates</Note>
...
<Note>
  Group Access Tokens are limited to the specific group where created. For
  multiple groups, you'll need separate tokens for each.
</Note>

<Frame>
  <img
    src="/images/connectors/gitlab/gitlab-gat.png"
    alt="Generating Group Access Token"
  />
</Frame>

<Frame>
  <img
    src="/images/connectors/gitlab/gitlab-gat-scopes.png"
    alt="Generating Group Access Token"
  />
</Frame>
...
<Warning>
  GitLab restricts Project-level Webhooks to users on the Premium or Ultimate
  tiers.
</Warning>
...
<Frame>
  <img
    src="/images/connectors/gitlab/gitlab-webhook.png"
    alt="Setting up MatterAI service account"
  />
</Frame>
...
<Frame>
  <img
    src="/images/connectors/gitlab/gitlab-webhook-scope.png"
    alt="Setting up MatterAI service account"
  />
</Frame>
...
<Frame>
  <img
    src="/images/connectors/gitlab/matterai-gitlab.png"
    alt="Setting up MatterAI service account"
  />
</Frame>
...
<Frame>
  <img
    src="/images/connectors/gitlab/gitlab-merge-request-summary.png"
    alt="Setting up MatterAI service account"
  />
</Frame>
...
<Frame>
  <img
    src="/images/connectors/gitlab/gitlab-merge-request-thread.png"
    alt="Setting up MatterAI service account"
  />
</Frame>
