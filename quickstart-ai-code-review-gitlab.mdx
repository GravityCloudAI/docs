...
4. Upload the **MatterAI logo** as the profile picture. You can find it here: [https://github.com/gravitycloudai/matterai/blob/main/logo.svg](https://github.com/gravitycloudai/matterai/blob/main/logo.svg)
...
1. Navigate to **MatterAI** -> **Connectors** -> **GitLab** and click on **Connect**. Console URL: [https://app.matterai.dev/connectors](https://app.matterai.dev/connectors)
