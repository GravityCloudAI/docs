...
title: "What is Axon?"
icon: "head-side-gear"
description: "Overview of Axon AI Models"
...
og:image: "https://res.cloudinary.com/dxvbskvxm/image/upload/v1758381085/axon-family_ykqtva.png"
...
**Axon offers secure, production-ready AI models for both code generation and general-purpose tasks, leveraging State-of-the-Art Deep Reasoning and State Machines**
...
<Frame>
  <img src="/images/axon/lcb.png" className="block" />
</Frame>

### Input Costs per Million Tokens

<Frame>
  <img src="/images/axon/input-costs.png" className="block" />
</Frame>

### Output Costs per Million Tokens

<Frame>
  <img src="/images/axon/output-costs.png" className="block" />
</Frame>
